 ...
 * @author antonio
 */
public class controlBajaVotante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int resultado;
            try {
                resultado = op.borrarVotante(Conexion, objV);
                if (resultado == 1){
                    String m = "Baja realizada";
                    response.sendRedirect("VISTA/vistaMensaje.jsp?mensaje="+m);      
                }
                else{
                    String m = "No esta registrado en el sistema";
                    response.sendRedirect("VISTA/vistaMensaje.jsp?mensaje="+m);
                }
